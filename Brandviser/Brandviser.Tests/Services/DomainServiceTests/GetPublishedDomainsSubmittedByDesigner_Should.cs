...
{
    [TestFixture]
    public class GetPublishedDomainsSubmittedByDesigner_Should
    {
        [Test]
        public void Call_Domain_Repository_Once()
        {
            ...
            // Act
            domainService.GetPublishedDomainsSubmittedByDesigner(designerId);
        ...
        public void Return_Correct_Results()
        {
            ...
            {
                new Domain {StatusId = 4, DesignerId = designerId},
                new Domain {StatusId = 4, DesignerId = designerId},
                new Domain {StatusId = 4, DesignerId = "wrongid"}
            ...
            // Act
            var expected = domainService.GetPublishedDomainsSubmittedByDesigner(designerId).ToList();
