...
{
    [TestFixture]
    public class GetSellerRejectedDomainsByUserId_Should
    {
        [Test]
        public void Call_Domain_Repository_Once()
        {
            ...
            // Act
            domainService.GetSellerRejectedDomainsByUserId(actualUserId);
        ...
        public void Return_Correct_Results()
        {
            ...
            {
                new Domain {UserId = actualUserId, Name = "testname", StatusId = 2},
                new Domain {UserId = actualUserId, Name = "testname2", StatusId = 2},
                new Domain {UserId = "wrongid", Name = "testname2", StatusId = 2}
            ...
            // Act
            var expected = domainService.GetSellerRejectedDomainsByUserId(actualUserId).ToList();
