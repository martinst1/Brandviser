...
{
    [TestFixture]
    public class GetSellerPendingDomainsByUserId_Should
    {
        [Test]
        public void Call_Domain_Repository_Once()
        {
            ...
            // Act
            domainService.GetSellerPendingDomainsByUserId(actualUserId);
        ...
        public void Return_Correct_Results()
        {
            ...
            {
                new Domain {UserId = actualUserId, Name = "testname", StatusId = 1},
                new Domain {UserId = actualUserId, Name = "testname2", StatusId = 1},
                new Domain {UserId = "wrongid", Name = "testname2", StatusId = 1}
            ...
            // Act
            var expected = domainService.GetSellerPendingDomainsByUserId(actualUserId).ToList();
