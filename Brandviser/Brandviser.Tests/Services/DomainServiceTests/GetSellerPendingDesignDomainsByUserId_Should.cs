...
{
    [TestFixture]
    public class GetSellerPendingDesignDomainsByUserId_Should
    {
        [Test]
        public void Call_Domain_Repository_Once()
        {
            ...
            // Act
            domainService.GetSellerPendingDesignDomainsByUserId(actualUserId);
        ...
        public void Return_Correct_Results()
        {
            ...
            {
                new Domain {UserId = actualUserId, Name = "testname", StatusId = 6},
                new Domain {UserId = actualUserId, Name = "testname2", StatusId = 6},
                new Domain {UserId = "wrongid", Name = "testname2", StatusId = 6}
            ...
            // Act
            var expected = domainService.GetSellerPendingDesignDomainsByUserId(actualUserId).ToList();
