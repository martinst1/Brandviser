...
{
    [TestFixture]
    public class GetSellerSoldDomainsByUserId
    {
        [Test]
        public void Call_Domain_Repository_Once()
        {
            ...
            // Act
            domainService.GetSellerSoldDomainsByUserId(actualUserId);
        ...
        public void Return_Correct_Results()
        {
            ...
            {
                new Domain {UserId = actualUserId, Name = "testname", StatusId = 5},
                new Domain {UserId = actualUserId, Name = "testname2", StatusId = 5},
                new Domain {UserId = "wrongid", Name = "testname2", StatusId = 5}
            ...
            // Act
            var expected = domainService.GetSellerSoldDomainsByUserId(actualUserId).ToList();
