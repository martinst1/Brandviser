...
{
    [TestFixture]
    public class GetSellerPublishedDomainsByUserId
    {
        [Test]
        public void Call_Domain_Repository_Once()
        {
            ...
            // Act
            domainService.GetSellerPublishedDomainsByUserId(actualUserId);
        ...
        public void Return_Correct_Results()
        {
            ...
            {
                new Domain {UserId = actualUserId, Name = "testname", StatusId = 4},
                new Domain {UserId = actualUserId, Name = "testname2", StatusId = 4},
                new Domain {UserId = "wrongid", Name = "testname2", StatusId = 4}
            ...
            // Act
            var expected = domainService.GetSellerPublishedDomainsByUserId(actualUserId).ToList();
