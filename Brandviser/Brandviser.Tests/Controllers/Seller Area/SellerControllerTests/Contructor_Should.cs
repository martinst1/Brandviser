...
namespace Brandviser.Tests.Controllers.Seller_Area.SellerControllerTests
{
    ...
    public class Contructor_Should
    {
        ...
        public void NotThrow_WhenCorrectParamsArePassed()
        {
            ...
            // Act and Assert
            Assert.DoesNotThrow(() => new SellerController(
        ...
        public void ThrowArgumentNullExceptionWithMessageContaining_IDomainService_WhenDomainServiceIsNull()
        {
            ...
            // Act and Assert
            Assert.That(() =>
            new SellerController(userService.Object, null, loggedInUser.Object),
        ...
        public void ThrowArgumentNullExceptionWithMessageContaining_IUserService_WhenUserServiceIsNull()
        {
            ...
            // Act and Assert
            Assert.That(() =>
            new SellerController(null, domainService.Object, loggedInUser.Object),
        ...
        public void ThrowArgumentNullExceptionWithMessageContaining_ILoggedInUser_WhenLoggedInUserIsNull()
        {
            ...
            // Act and Assert
            Assert.That(() =>
            new SellerController(userService.Object, domainService.Object, null),
