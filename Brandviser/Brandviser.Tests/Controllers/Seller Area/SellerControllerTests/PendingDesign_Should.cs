...
{
    [TestFixture]
    public class PendingDesign_Should
    {
        [Test]
        public void Call_LoggedInUser_GetUserId_Once()
        {
            ...
            domainService.Setup(d => d.GetSellerPendingDesignDomainsByUserId(userId)).Returns(domains.AsQueryable<Domain>());

            // Act
            sellerController.PendingDesign();
